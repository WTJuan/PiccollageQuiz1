...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        effectButton.addTarget(self, action: #selector(self.effectButtonTapped(_:)), for: .touchUpInside)
...
//        }
    ...
    func showError() {
        let alert = UIAlertController(title: "Error", message: "No video", preferredStyle: .alert)
